...
maturity_red_plot <- ggplot(data=maturity_dat_red, aes(x=genotype, y=value, fill=location)) +
  ...
  coord_cartesian(ylim = c(0,20))+ #creates the limits of the graph
  theme(legend.position = "none")+ #gets rid of legend
  labs(y = "AL's per AIY Neuron")+
  geom_signif(comparisons = list(c('control','unc-33(mn407)' )), #this will be the significance for first facet
