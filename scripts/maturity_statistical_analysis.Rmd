...
maturity_dat$genotype <- factor(trafdat$genotype, levels =c("control", "unc-33(mn407)", "unc-33(e204)" ))
...
#subset the columns that will be used in analysis and renames columns to more readable names
   maturity_dat_red <- rstduiomaturity_dat %>% select(id, genotype, avg_neurite_auto_count_red, avg_soma_red_auto, avg_cell_auto_count_red)
maturity_dat_red
