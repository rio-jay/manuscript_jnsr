...
bartlett.test(data = trafdat, neurite_avg ~ genotype )#test for homogeneity of variance (which is needed for kruskal wallis)
...
aov_residuals <- resid(one.way) #extracts residuals from linear model
shapiro.test(x=aov_residuals) #tests for normality of data set
bartlett.test(data = trafdat, soma_avg ~ genotype ) #test for homogeneity of variance (which is needed for kruskal wallis)
...
aov_residuals <- resid(one.way) #extracts residuals from linear model
shapiro.test(x=aov_residuals) #tests for normality of data set
bartlett.test(data = trafdat, cell_avg ~ genotype ) #test for homogeneity of variance (which is needed for kruskal wallis)
